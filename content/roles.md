...
<dd>Content Strategist, Content Creator, Content Designer, Content Author, Digital Copywriter, UX Writer, Content Producer, Content Editor, Technical Writer, Script Writer, Video Producer, Podcast Host</dd></dl>

### Content Publishing

Team members who are not Front-end Developers that are tasked with preparing content for publishing to websites, products, applications, etc. These team members do not author content, instead they work with the content within specific business enterprise systems or software tools and apply edits to material generated by content authors.

Content Publishers may perform some tasks that are a part of the Front-end Developer skillset, however they are not Developers and are often applying this markup using proprietary tools and widget.
